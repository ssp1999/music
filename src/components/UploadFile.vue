                ...
                <div class="mb-4" v-for="upload in uploads" :key="upload.name">
                    ...
                    <div class="flex h-4 overflow-hidden bg-gray-200 rounded">
                        ...
                        <div class="transition-all progress-bar bg-blue-400"
                            :style="{ width: upload.current_progress + '%' }" :class="upload.variant">
                        </div>
                    </div>
                </div>
            </div>
    ...
    methods: {
        upload($event) {
            ...
            files.forEach((file) => {
                ...
                const uploadIndex = this.uploads.push({ task, current_progress: 0, name: file.name, variant: 'bg-blue-400', icon: 'fas fa-spinner fa-spin', text_class: '' }) - 1
